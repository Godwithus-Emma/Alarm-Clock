...
void loop()
{
   DateTime _now = DS3231M.now();
   Serial.println(_now.hour());
    DS3231M.setAlarm(secondsMinutesHoursDateMatch, _now + TimeSpan(0, 0, 0, 12));  // Alarm goes off in 12 seconds
